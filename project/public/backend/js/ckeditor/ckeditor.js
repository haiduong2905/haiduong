	...
	(function() {
	        ...
	        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
	            d = {
	                ...
	                domReady: function() {
	                    ...
	                    return function(b) {
	                        function n() {
	                            try { document.documentElement.doScroll("left") } catch (e) { setTimeout(n, 1); return }
	                            a()
	                        }
	                        c.push(b);
	    ...
	    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
	        ...
	        return {
	            ...
	            on: function(b, d, h, k, g) {
	                ...
	                function r() { y.removeListener(b, d) }
	                var e = a.call(this, b);
	        ...
	        CKEDITOR.tools = {
	            ...
	            transformPlainTextToHtml: function(a, e) {
	                ...
	                if (!b) {
	                    ...
	                    if (g.test(v)) var d = "\x3c" + c + "\x3e",
	                        m = "\x3c/" + c + "\x3e",
	                        v = d + v.replace(g, function() { return m + d }) + m
	                }
	                v = v.replace(/\n/g, "\x3cbr\x3e");
	            ...
	            throttle: function(a, e, b) {
	                ...
	                return {
	                    ...
	                    reset: function() { c && (clearTimeout(c), c = g = 0) }
	                }
	            },
	            ...
	            cssLength: function() {
	                var a = /^-?\d+\.?\d*px$/,
	                    e;
	                return function(b) { e = CKEDITOR.tools.trim(b + "") + "px"; return a.test(e) ? e : b || "" }
	            }(),
	            ...
	            array: {
	                filter: function(a, b, c) {
	                    var g = [];
	                    this.forEach(a, function(d, n) { b.call(c, d, n, a) && g.push(d) });
	                    return g
	                },
	                ...
	                switch (a) {
	                    ...
	                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
	                        ...
	                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
	                            ...
	                            l.evaluator = function(a) { return !w(a) && !A(a) };
	    ...
	    (function() {
	        ...
	        function e(a) {
	            var b, c, d, f, e = {},
	                l = 1;
	            for (a = z(a); b = a.match(p);)(c = b[2]) ? (d = y(c, "styles"), f = y(c, "attrs"), c = y(c, "classes")) : d = f = c = null, e["$" + l++] = { elements: b[1], classes: c, styles: d, attributes: f }, a = a.slice(b[0].length);
	            return e
	        }
	        ...
	        CKEDITOR.filter.prototype = {
	            allow: function(b, c, d) {
	                ...
	                } else if (CKEDITOR.tools.isArray(b)) { for (f = 0; f < b.length; ++f) l = this.allow(b[f], c, d); return l }
	            ...
	            check: function(a, b, c) {
	                ...
	                } else f = a.getDefinition(), l = f.styles, d = f.attributes || {}, l && !CKEDITOR.tools.isEmpty(l) ? (l = E(l), d.style = CKEDITOR.tools.writeCssText(l, !0)) : l = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: l, children: [] };
	    ...
	    (function() {
	        ...
	        CKEDITOR.htmlParser.fragment.fromHtml =
	            function(h, k, g) {
	                ...
	                function B(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 }
	    ...
	    (function() {
	        ...
	        function e(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + B(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }
	        ...
	        function B(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }) }
	        ...
	        function x(a, b) {
	            ...
	            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, f) { return "\x3c" + c + d + "\x3e" + D(B(f), b) + "\x3c/" + c + "\x3e" })
	        }
	    ...
	    (function() {
	        ...
	        function h(a) {
	            function b(a) { return function(b, e) { e && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(e || !c(b) || a && B(b))) return !1 } }
	            ...
	            proto: {
	                ...
	                insertElement: function(a, b) {
	                    ...
	                    this.insertElementIntoRange(a,
	                        b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) { return c(a) && !B(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
	                    d.selectRanges([b]);
	                    n(this)
	                },
	        ...
	        x = function() {
	            ...
	            return function(z, p, N, w) {
	                ...
	                if (!w.checkReadOnly()) {
	                    ...
	                    z = { type: p, dontFilter: G, editable: z, editor: A, range: w, blockLimit: I, mergeCandidates: [], zombies: [] };
	                    p = z.range;
	                    w = z.mergeCandidates;
	                    var n, r;
	                    ...
	                    if (n = N) {
	                        ...
	                        N = z.editor.dataProcessor.toHtml(N, { context: null, fixForBody: !1, protectedWhitespaces: !!x, dontFilter: z.dontFilter, filter: z.editor.activeFilter, enterMode: z.editor.activeEnterMode });
	                    ...
	                    if (!z.dontMoveCaret) {
	                        for (D = e(B); D && a(D) && !D.is(E.$empty);) {
	                            if (D.isBlockBoundary()) B.moveToPosition(D,
	                                ...
	                                if (f(D) && D.getHtml().match(/(\s|&nbsp;)$/g)) { R = null; break }
	                                R = B.clone();
	            ...
	            tree: {
	                rebuild: function(a, b) {
	                    ...
	                    if (e.blockLimit.is({
	                        ...
	                        g = function(a) { return !a.equals(z) }
	                    }
	    ...
	    (function() {
	        ...
	        CKEDITOR.dom.selection.prototype = {
	            ...
	            getSelectedElement: function() {
	                ...
	                var b = this,
	                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && M[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
	    ...
	    (function() {
	        ...
	        function c(a) {
	            ...
	            if (a.collapsed) {
	                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
	                    if (this.checkElementRemovable(k)) { var m;!e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = m ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? B.call(this, k) : x(k, l(this)[k.getName()])) }
	                if (g) {
	                    e = d;
	                    for (h =
	                        0;; h++) {
	        ...
	        function K(a, b) { for (var c in a) a[c] = a[c].replace(E, function(a, c) { return b[c] }) }
	                ...
	                if (n.type == CKEDITOR.NODE_ELEMENT) {
	                    ...
	                    if (!k && (r = n.getName(),
	                        ...
	                        if (r = !h && "div" == r) {
	                            a: {
	                                r = n.getChildren();
	                                for (var e = 0, y = r.count(); e < y; e++) { var v = r.getItem(e); if (v.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[v.getName()]) { r = !0; break a } }
	                                r = !1
	                            }
	                            r = !r
	                        }
	    ...
	    (function() {
	        ...
	        function x(a) {
	            ...
	            (function() {
	                ...
	                if (a.contextMenu) {
	                    a.contextMenu.addListener(function(a, b) { v = b.getRanges()[0].checkReadOnly(); return { cut: q("cut"), copy: q("copy"), paste: q("paste") } });
	                    var c = null;
	        ...
	        CKEDITOR.plugins.add("clipboard", {
	            ...
	            init: function(a) {
	                ...
	                a.on("paste", function(b) {
	                        b = b.data;
	                        b.dataValue && (a.insertHtml(b.dataValue, b.type, b.range), setTimeout(function() { a.fire("afterPaste") }, 0))
	                    }, null, null,
	                    1E3);
	                    ...
	                    if (document.body.createTextRange) {
	                        ...
	                        try {
	                            for (var f = !1, l = 0; 20 > l && !f; l++) {
	                                if (!f) try { c.moveToPoint(d, g - l), f = !0 } catch (m) {}
	        ...
	        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
	            ...
	            isEmpty: function() {
	                ...
	                CKEDITOR.tools.array.forEach(CKEDITOR.tools.objectKeys(this._.data), function(b) { a[b] = 1 });
	                if (this.$)
	                    if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) {
	                        if (this.$.types)
	        ...
	        CKEDITOR.plugins.enterkey = {
	            enterBlock: function(a, e, b, g) {
	                ...
	                if (b = b || y(a)) {
	                    ...
	                    } else if (c && c.is("pre") && !f) { u(a, e, b, g); return }
	                    if (q = b.splitBlock(l)) {
	                        a = q.previousBlock;
	                        c = q.nextBlock;
	                        n = q.wasStartOfBlock;
